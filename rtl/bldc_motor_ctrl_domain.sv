module bldc_motor_ctrl_domain (
    ...
    always_ff @(posedge clk_motor or negedge rst_n) begin
        logic       cmd_edge;
            ...
            if (cmd_edge) begin
                if (cmd_write_async) begin
                    case (cmd_addr_async)
                        ADDR_CONTROL: begin
                            merged_write_data = apply_wstrb(
                                {28'd0, speed_ctrl_enable_reg, direction_reg, auto_comm_enable_reg, drive_enable_reg},
                                cmd_wdata_async,
                                cmd_wstrb_async
                            );
                    ...
                    case (cmd_addr_async)
                        ...
                        ADDR_CONTROL: begin
                            read_data = {28'd0, speed_ctrl_enable_reg, direction_reg, auto_comm_enable_reg, drive_enable_reg};
                        end
                        ADDR_PWM_CFG: begin
